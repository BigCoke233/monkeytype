...
import { getStore, setStore } from "@/lib/utils/useLocalStorage";

/* === 数据 === */

var originalData = getStore('PhraseHistory')
...
export function PushToHistory(phrase) {
    ...
    setStore('PhraseHistory', JSON.stringify(PhraseHistory)) //将数组转为 JSON 字符，然后存入 localStorage
}
